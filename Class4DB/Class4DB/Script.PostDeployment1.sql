...
IF NOT EXISTS (SELECT 1 FROM Student_Class)
BEGIN
...
INSERT INTO Student_Class VALUES (2,3,GETDATE(),NULL)
INSERT INTO Student_Class VALUES (3,2,GETDATE(),NULL) 
INSERT INTO Student_Class VALUES (3,3,GETDATE(),NULL) 
END

SELECT DISTINCT ClassName, ClassNumber, dbo.udf_GetAllStudentsPerClass(Id) AS NumberOfStudents FROM Class
